...
@pytest.mark.parametrize("body, expected_output", [
    (
        ...
        ("Hello world", ["https://example.com/file1.txt", "https://example.com/file2.txt"], "test-channel", "1234567890.123456")
    ),
    (
        {
            "event": {
...
async def test_extract_info(body: Dict[str, Dict[str, str]], expected_output: Tuple[str, List[str], str, str]) -> None:
